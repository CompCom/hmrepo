...
Step 3: Edit the config.ini to change the image size if needed (default=300x300)
Step 4: When you have added all users install this hmod to the snes mini.
Step 5: ???
Step 6: Profit

Note: Default id for nand is "clover". If you remove "clover" id you will not be able to access your existing nand saves.
